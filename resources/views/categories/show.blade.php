...
<body>
    ...
    <main>
  <div class="position-relative overflow-hidden p-md-5  text-center color">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal white">{{ $category->name }}</h1>
...
<div class="album py-5" style="margin-top:15rem;">
    <div class="container">
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('products.edit', ['product' => $product->id_product]) }}">Edit</a>
